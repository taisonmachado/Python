...
print("Equação de Segundo grau (ax^2 + bx + c): ")
a = float(input("Digite o valor de a: "))
if(a==0):
    print("Equacao nao é de segundo grau.")
else:
    ...
    if(delta<0):
        ...
        raiz = (-b)/(2*a)
        print("A equação só tem uma raiz: x = %.2f" %raiz)
    else:
        raiz1 = (-b + (delta**0.5))/(2*a)
        raiz2 = (-b - (delta**0.5))/(2*a)
        
        print("A equação possui duas raízes: x1 = %.2f e x2 = %.2f" %(raiz1,raiz2))